...
review3 = Review.create(post_date: "2017-7-19", rating: 5, review: "Absolutely terrible. 100% do not recommend", user_id: user2.id, trail_id: trail3.id)
review4 = Review.create(post_date: '2016-1-10', rating: 5, review: "Had an amazing time.  Would've been even better if there wasn't so much traffic on the trail.  Still amzaing!!!", user_id: user4, trail_id: trail3.id)
...
review7 = Review.create(post_date: '2010-6-14', rating: 5, review: "Everything sucked.  The waterfall sucked. The trail sucked. It all sucked.", user_id: demo.id, trail_id: trail2.id)
review8 = Review.create(post_date: '2011-8-10', rating: 5, review: "It was a very nice trail.  Not to tough, not to easy.  The waterfall was so nice, was definitely my favorite part!", user_id: user1.id, trail_id: trail2.id)
review9 = Review.create(post_date: '2020-4-21', rating: 4, review: "It was nice, nothing special.  You've seen one waterfall you've seen them all", user_id: user3.id, trail_id: trail2.id)
...
review12 = Review.create(post_date: '2017-6-22', rating: 4, review: "It was alrgiht", user_id: user4.id, trail_id: trail4.id)
...
review15 = Review.create(post_date: '2010-5-20', rating: 4, review: "I hated it! >:|", user_id: user4.id, trail_id: trail7.id)
review16 = Review.create(post_date: '2010-8-22', rating: 5, review: "Such an amazing hike!", user_id: user2.id, trail_id: trail7.id)
review17 = Review.create(post_date: '2020-9-15', rating: 4, review: "Such a bad hike", user_id: demo.id, trail_id: trail5.id)
